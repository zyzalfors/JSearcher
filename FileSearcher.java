...
public class FileSearcher
{
 ...
 public static void main(String[] args)
 {
  ...
  JFrame mainFrame = new JFrame("JSearcher v1.0.0");
  ...
  (
   new ActionListener()
   {
    ...
    {
     JOptionPane.showMessageDialog(null, "Author: zyzalfors\nVersion: 1.0.0", "About JSearcher v1.0.0", JOptionPane.INFORMATION_MESSAGE);
    }
   }
  );
   ...
   new ActionListener()
   {
    public void actionPerformed(ActionEvent e)
    {
     ...
     else
     {
      ...
      JFrame reportFrame = new JFrame ("JSearcher v1.0.0 Report");
